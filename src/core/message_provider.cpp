...
MessageProvider::MessageProvider(std::vector<std::string> messages, bool rotate, bool random)
      ...
      rng_(std::random_device{}())
{
  ...
  spdlog::debug("MessageProvider created with {} messages, rotate={}, random={}", messages_.size(),
                rotate_, random_);
}

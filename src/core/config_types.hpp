...
template <>
struct glz::meta<blinkbreak::Duration> {
    using T = blinkbreak::Duration;
    static constexpr auto value = glz::custom<
        [](T& v, int64_t count) { v = T(count); },
        [](const T& v) -> int64_t { return v.count(); }
    >;
};
...
struct glz::meta<blinkbreak::BreakConfig> {
    ...
    static constexpr auto value = glz::object(
        ...
        "messages", &T::messages,
        "rotate_messages", &T::rotate_messages
    );
};
...
struct glz::meta<blinkbreak::NotificationConfig> {
    ...
    static constexpr auto value = glz::object(
        "enabled", &T::enabled,
        "warning_seconds", &T::warning_time,
        "respect_dnd", &T::respect_dnd
    );
};
...
struct glz::meta<blinkbreak::OverlayConfig> {
    ...
    static constexpr auto value = glz::object(
        "opacity", &T::opacity,
        "show_on_all_monitors", &T::show_on_all_monitors,
        "allow_skip", &T::allow_skip,
        "allow_snooze", &T::allow_snooze,
...
struct glz::meta<blinkbreak::AppConfig> {
    ...
    static constexpr auto value = glz::object(
        ...
        "overlay", &T::overlay,
        "theme", &T::theme,
        "start_minimized", &T::start_minimized,
